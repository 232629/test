...
namespace UITestDirect2
{
    ...
    public partial class UITestDirect2Mena
    {
        ...
        public void RegistrationNewUser_UAE_No_No_No_Screenshot(string lng)
        {
            ...
            AssertHelper.AssertScreenShot(ngWebDriver.WrappedDriver, pageLogin.ScreenShot, 0);
            pageLogin.LnkCreateAnAccount.Click();
            ngWebDriver.WaitForAngular();

            //Registration Step 0
            PageRegister pageRegister = new PageRegister(ngWebDriver, lng);
            AssertHelper.AssertScreenShot(ngWebDriver.WrappedDriver, pageRegister.ScreenShot, 0);
            ...
            AssertHelper.AssertScreenShot(ngWebDriver.WrappedDriver, pageRegisterStep1.ScreenShot, 0);
            ...
            AssertHelper.AssertScreenShot(ngWebDriver.WrappedDriver, pageRegisterStep2.ScreenShot, 0);
            ...
            AssertHelper.AssertScreenShot(ngWebDriver.WrappedDriver, pageRegisterStep3.ScreenShot, 0);
