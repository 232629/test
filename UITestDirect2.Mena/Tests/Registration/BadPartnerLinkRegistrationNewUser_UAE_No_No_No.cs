...
namespace UITestDirect2
{
    ...
    {
        /// <summary>
        /// Registration new UAE user, wiht not exist partner.
        /// 
        /// 0 step: 
        /// DFSA
        ...
        public void BadPartnerLinkRegistrationNewUser(string lng)
        {
            #region Test Data
            ...
            //Partner ups-0123456789 is not exist
            pageRegister.GoToPage(pageRegister.BaseUrl + "/partner/ups1234567890");
